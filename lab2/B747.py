...
class B747(JetPlane):
    def __init__(self,accelerator=None):
        ...
        self.accelerator=input("введите название ускорителя установленного на данный аппарат - ")
    def GetInfo(self):
        print("Новосозданный реактивный самолёт имеет " +self.color+ " цвет и длину корпуса " + self.length + " м. Имеет максимальную скорость " + self.speed + " километров в час. На борту B747 был установлен ускоритель " +self.accelerator)
b747=B747()
b747.GetInfo()
